...
class App extends BaseConfig
{
	...
	*/
	...
	//public $baseURL = 'http://vnapp.ventasnube.com/';
	...
	*/
	...
	|--------------------------------------------------------------------------
	|	
	| Si es cierto, esto obligará a que todas las solicitudes realizadas a esta aplicación sean
	| realizado a través de una conexión segura (HTTPS). Si la solicitud entrante no es
	| seguro, el usuario será redirigido a una versión segura de la página
	...
	*/
	...
	public $sessionExpiration        = 82000;
