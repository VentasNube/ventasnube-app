...
*/
                            ...
                            'seach' => [
                               'map' =>  "function(doc) {\n if( doc.type === 'product'){\n            var attribute_combinations = new Array();\n   for(var i=0, length=doc.variations.length; i<length; i++){\n     \n                  var price_list = doc.variations[0].price_list;\n                 \n                  var stock_invetary =  doc.variations[0].stock_invetary;\n                 \n                  var pictures_min = doc.variations[0].pictures[0].min;\n                  \n                  var pictures_max = doc.variations[0].pictures[0].max;\n                  \n                  var sku = doc.variations[0].sku.value;\n                  \n                  var variant_id = doc.variations[0].id;\n                  \n                  var attribute_combinations = doc.variations[0].attribute_combinations\n                \n               }\n             emit([doc.name],{\n                    '_id': doc._id,\n                    '_rev':doc._rev,\n                    'variant_id':variant_id,\n                    'tipo': doc.type,\n                    'name': doc.name,\n                    'tags': doc.tags,\n                    'currency': doc.variations[0].currency.value,\n                    'cost_price': doc.cost_price,\n                     'price':doc.variations[0].price_list[0].value,\n                     'price_list':price_list,\n                      'stock_invetary':stock_invetary,\n                      'available_quantity':doc.variations[0].available_quantity,\n                      'sold_quantity':doc.variations[0].sold_quantity,\n                       'limit_discount':doc.variations[0].limit_discount,\n                       'status':doc.variations[0].status,\n                    'sku': sku,\n                  'picture_min':pictures_min,\n                 'picture_max':pictures_max,\n                 'attribute_combinations':attribute_combinations,\n });\n}\n}\n"
                            ],
                            'search' => [
                                'map' =>  "function(doc) {\n if( doc.type === 'product'){\n            var attribute_combinations = new Array();\n   for(var i=0, length=doc.variations.length; i<length; i++){\n     \n                  var price_list = doc.variations[0].price_list;\n                 \n                  var stock_invetary =  doc.variations[0].stock_invetary;\n                 \n                  var pictures_min = doc.variations[0].pictures[0].min;\n                  \n                  var pictures_max = doc.variations[0].pictures[0].max;\n                  \n                  var sku = doc.variations[0].sku.value;\n                  \n                  var variant_id = doc.variations[0].id;\n                  \n                  var attribute_combinations = doc.variations[0].attribute_combinations\n                \n               }\n             emit([doc.name],{\n                    '_id': doc._id,\n                    '_rev':doc._rev,\n                    'variant_id':variant_id,\n                    'tipo': doc.type,\n                    'name': doc.name,\n                    'tags': doc.tags,\n                    'currency': doc.variations[0].currency.value,\n                    'cost_price': doc.cost_price,\n                     'price':doc.variations[0].price_list[0].value,\n                     'price_list':price_list,\n                      'stock_invetary':stock_invetary,\n                      'available_quantity':doc.variations[0].available_quantity,\n                      'sold_quantity':doc.variations[0].sold_quantity,\n                       'limit_discount':doc.variations[0].limit_discount,\n                       'status':doc.variations[0].status,\n                    'sku': sku,\n                  'picture_min':pictures_min,\n                 'picture_max':pictures_max,\n                 'attribute_combinations':attribute_combinations,\n });\n}\n}\n"
                            ],
