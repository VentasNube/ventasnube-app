...
class Search extends BaseController
{
    ...
    //Datos genericos para abrir el tempalte
    ...
    //Traigo los datos del serach template
  /*  public function search_m_template()
	...
	//Traigo los datos del Card Product
	public function search_card_product_template()
	{
        if (!logged_in()) {
            return redirect()->to('login');
        } else {
            return view('search/card_product.hbs');
		}
	}

    //Traigo los datos del Card Product
	public function search_card_product_variant_template()
	{
        if (!logged_in()) {
            return redirect()->to('login');
        } else {
            return view('search/card_product_variant.hbs');
		}
	}

      //Traigo los datos del Card Product
	public function search_card_product_var_select_template()
	{
        if (!logged_in()) {
            return redirect()->to('login');
        } else {
            return view('search/card_product_var_select.hbs');
		}
	}
*/
