...
class AuthVn extends Controller
{
	protected $auth;
	/**
	 * @var Auth
...
*/
	...
	{
		// Compruebe si se permite el registro
		if (! $this->config->allowRegistration)
		{
			return redirect()->back()->withInput()->with('error', lang('Auth.registerDisabled'));
		}
		$users = model(UserModel::class);
		// Valide aquí primero, ya que algunas cosas,
		// Como la contraseña, solo se puede validar correctamente aquí.
		$rules = [
