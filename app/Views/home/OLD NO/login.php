...
<body class="login" style="background-image: url(/public/assets/img/banner--ventas-Nube.png)">
    <div class="container">
        <div class="row justify-content-md-center align-items-center">
            <form class="form-signin col-10 col-sm-8 col-md-6 col-xl-4 text-center" id="formLogin" method="POST" action="<?= site_url('login'); ?>" accept-charset="UTF-8">
                ...
                <?= view('App\Views\home\_message_block') ?>
                <div class="text-left">
                ...
                <a href="<?= site_url('forgot-password'); ?>">
                    <p class="mt-4 mb-3 text-muted"><?= lang('Auth.forgotYourPassword') ?></p>
                </a>
            </form>
        </div>
    </div>
