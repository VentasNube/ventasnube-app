    ...
    <main class="ws_config_tuto_main">
        ...
        <div class="jumbotron pd-vn paral mb-0 " style="background-image: url('/public/app/v4.0/assets/img/banner--ventas-Nube.png');">
            <div class="jumbo-main">
                ...
                <div style="z-index: 11111111111111;    position: relative;  display: block;">
                    ...
                    <h3 class="m-0 text-muted"><?=lang('Ws_setup.ws_config_step_3_sub_tittle')?></h3>
                        ...
                        <div class="col-12 container">
                            <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <input disabled checked type="checkbox" name="ws_collections" value="ws_collections" class="checkbox" id="ws_collections">
                                                <label disabled for="ws_collections" class="chek_box_label radio-check-lg bmd-label-floating">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <input disabled  checked type="checkbox" name="ws_contact" value="ws_contact" class="checkbox" id="ws_contact">
                                                <label disabled for="ws_contact" class="chek_box_label radio-check-lg bmd-label-floating">
                                                <span class="material-icons">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <input disabled checked type="checkbox" name="ws_sell" value="ws_sell" class="checkbox" id="ws_sell">
                                                <label disabled  for="ws_sell" style="" class="chek_box_label radio-check-lg bmd-label-floating">
                                                <span class="material-icons">
...
<script>
 //$(document).ready(function() {
    ...
    $("#nav_finish").click( function() {
        if(validaForm()){
            const data = new FormData(document.getElementById('ws_new_form'));
            $(this).html('Creando    <i class="fas fa-spinner fa-pulse"></i>');
            $(this).attr('disabled', '');
            console.log(data);
        (async () => {
            var init = {
            ...
            try {
                var response = await fetch('/workspace/ws_new',init);
                ...
                if (datos.result == true) {
                    ...
                    $(location).attr('href','<?php echo base_url(); ?>/workspace/home');
                } else {
                    Snackbar.show({
                                text: datos.msj,
                                actionText: 'ok',
                ...
                Snackbar.show({
                                text:"Error al realizar la petición AJAX: "+err.message,
                                actionText: 'ok',
                                actionTextColor: "#e91e63",
                            });
                $(this).html('Volver a intentar!');
