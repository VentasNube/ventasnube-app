...
function search_item_js(search_val) {
    var url_template = '/public/dist/hbs/search/card_product.hbs'; //NOMBRE CONTROLADOR TEMPLATE      
...
function variations_get(element) {
    ...
    let url_template = '/public/dist/hbs/search/card_product_variant.hbs'; //NOMBRE CONTROLADOR TEMPLATE      
...
function variations_select(element) {
    ...
    let url_template = '/public/dist/hbs/search/card_product_var_select.hbs'; //NOMBRE CONTROLADOR TEMPLATE      
