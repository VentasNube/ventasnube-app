...
// ARMA EL TEMPLATE PARA COMPILAR
async function get_module(controler_data, controler_template, id_copiled, data) { // Ejemplo : body, top_bar, top_bar_template, ##top_nav-bar-copiled
    // ID DE COMPILACION //      
    ...
    //// CONTRUCTOR de URLS /// 
    var url_data = controler_data; // Controlador que devuelve el array con la info
    var url_template = controler_template; // Controlador que devuelve el template de la vista
