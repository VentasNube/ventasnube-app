...
class VCardIFL {
    ...
    var $vcard_birtda;//  Birthday YYYY-MM-DD
	var $vcard_f_name;//  Family name
	var $vcard_cellul;//  Cellular Phone Number  Mobile
	var $vcard_compan;//  Company Name
	var $vcard_h_addr;//  Street Address (home)
	var $vcard_h_city;//  City (home)
	var $vcard_h_coun;//  Country (home)
	var $vcard_h_fax ;//  Fax (home)
	var $vcard_h_mail;//  E-mail (home)
	var $vcard_h_phon;//  Phone (home)
	var $vcard_h_zip ;//  Zip-code (home)
	var $vcard_nickna;//  Nickname
	var $vcard_note  ;//  Note
	var $vcard_s_name;//  Given name
	var $vcard_uri   ;//  Homepage, URL
	var $vcard_w_addr;//  Street Address (work)
	var $vcard_w_city;//  City (work)
	var $vcard_w_coun;//  Country (work)
	var $vcard_w_fax ;//  Fax (work)
	var $vcard_w_mail;//  E-mail (work)
	var $vcard_w_phon;//  Phone (work)
	var $vcard_w_role;//  Function (work)
	var $vcard_w_titl;//  Title (work)
	var $vcard_w_zip ;//  Zip-code (work)
    var $vcard_w_uri ;//  Home URL
    var $vcard_h_uri ;//  WORK URL
    var $vcard_p_pager;// Pager Number

    var $fileName;    //  File Name Download or Save
    var $saveTo;      //  Save To Address Folder To Save (on Server)

    // private var
    var $vcard_addr;
    var $vcard_labl;
    var $vcard;      //  Vcard Data Set



   function VCardIFL ($arData) {
   ...
   // Save Vcard in Host
   function SaveVcard ($randName=false) {
   if($randName) {
